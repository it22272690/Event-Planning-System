    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="user-actions">
                <button id="edit-customer" style="color:white; width:250px; height:100px;">Edit Customer Form</button>
                <button id="edit-event" style="color:white; width:250px; height:100px;">Edit Event Details Form</button>
                <button id="edit-payment" style="color:white; width:250px; height:100px;"><a href="Payment.jsp">Edit Payment Form</a></button>
            </div>
        </div>
       <footer id="footer">
