...
<title>Insert title here</title>
  ...
  <script>function showMessage() {
    alert("Your form has been submitted successfully!");		<!-- show pop up message when the form is submitted using java script -->
}
	</script>
</head>
<body>
 ...
 <div class="container">
    ...
    <form action="PaymentInsert" method="post">
        ...
        <input type="submit" value="Pay" class="submit-btn" name="submit" onclick="showMessage()"> 	<!-- show the pop up message when click on the Pay button-->
